export default {
  ...
  'validator.login.password.required' : 'Password is Required!',
  ...
  'validator.admin.attribute.name.required': 'Attribute name is Required！',
  'validator.admin.locale.required': 'Locale is Required!',
  'validator.admin.pms.product.categoryId.required': 'Product category is Required!',
}